...
if(isset($_POST["query"]))
{
	...
	$connect = new PDO("mysql:host=localhost; dbname=music_society", "root", "");
	...
	if($_POST["query"] != '')
	{
		...
		foreach($result as $row)
		{
			$data[] = array(
				'id'			=>	$row["id"],
				'full_name'		=>	str_ireplace($replace_array_1, $replace_array_2, $row["full_name"]),
				'phone_no'	=>	str_ireplace($replace_array_1, $replace_array_2, $row["phone_no"])
			);
		}
